...
import { DownOutlined, SettingOutlined, BarsOutlined, LogoutOutlined } from '@ant-design/icons'
import { connect } from 'react-redux'
import { withRouter } from 'react-router-dom'
import PropTypes from 'prop-types'
import 'antd/dist/antd.css'
import { login_out_action } from '../setting/action'
function UserInfoComponent (props) {
  const { visible, overlay, visibleChange } = props
  return (
...
function getMenu ({ exit, personal }) {
  return (
    <Menu>
      <Menu.Item key="profile" onClick={personal} ><SettingOutlined />Setting</Menu.Item>
